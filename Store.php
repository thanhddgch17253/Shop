...
<body>
    <header class="container">
        ...
        <a href="createoder.php"><button class="btn btn-outline-primary">Create Order</button></a>
    ...
    <section class="container">
        <table class="table">
            <tr>
                ...
                <th>Price</th>
                <td><a href="add.php"><button class="btn btn-outline-primary">Add Product</button></a></td>
            </tr>
